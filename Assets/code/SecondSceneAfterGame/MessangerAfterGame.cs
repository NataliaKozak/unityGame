...
public class MessangerAfterGame : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        WriteMessage("Вернитесь в первую комнату, чтобы закончить испытание."); // напишите сюда первое сообщение для пользователя
    }
